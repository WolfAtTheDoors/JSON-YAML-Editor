    ...
    public sealed partial class JSONListe3 : Page {
        ...
        private void GoToBestaetigen(object sender, RoutedEventArgs e) {
            if (Offnen.objektNameNummerListe.Count != 0) {
                ...
                for (int i = 0; i < Offnen.objektNameNummerListe.Count; i++) {

                    if (Offnen.objektNameNummerListe[i].All(char.IsDigit)) {
                        OriginalChangedObject = OriginalChangedObject[int.Parse(Offnen.objektNameNummerListe[i])]!;
                    }
                    else {
                        OriginalChangedObject = OriginalChangedObject[Offnen.objektNameNummerListe[i]]!;
                    }
                }
                ...
                //Versuch Nummer 2: Finde einen Weg, das Objekt durch seine Adresse zu ersetzen
